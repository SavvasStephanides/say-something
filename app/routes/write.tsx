...
export const loader = async () => {
    ...
    let writeHtml = `<h1 id="submit-your-own-message-on-say-something-">Submit your own message on Say Something!</h1>
    ...
    <h2 id="step-2-copy-the-project-code-on-your-profile">Step 2: Copy the project code on your profile</h2>
    ...
    <h2 id="step-3-create-a-file-with-your-message">Step 3: Create a file with your message</h2>
    ...
    <img src="/write-page-assets/create-new-file-menu.png" alt="">
    ...
    &lt;Your message&gt;</code></p>
    <p>For example:</p>
    <p><code>By: John Doe</p>
    <p>Just dropping by to say hello!</code></p>
    <img src="/write-page-assets/message-input.png" alt="">
    
    <p>Once you&#39;re done, click the green <em>Commit changes</em> button.</p>
    <img src="/write-page-assets/commit-button.png" alt="">
    ...
    <img src="/write-page-assets/commit-changes-dialog.png" alt="">
    ...
    <p><code>git clone &lt;URL you just copied&gt;</code></p>
    ...
    <p><code>cd say-something
    cd apps/messages</code></p>
    ...
    <p>(<code>-m</code> basically means &quot;what I write next is a message)</p>
    ...
    <img src="/write-page-assets/updated-fork.png" alt="">
    
    </details>
    
    <p>Lastly, we need to add your message to the main website, for the world to see! 👀</p>
    <h2 id="step-4-ask-for-your-changes-to-be-put-on-the-main-repository">Step 4: Ask for your changes to be put on the main repository</h2>
